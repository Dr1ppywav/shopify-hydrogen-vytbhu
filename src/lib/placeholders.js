...
const PLACEHOLDERS = {
  HEROS: [
    // primaryHero
    {
      heading: { value: 'TrappedVintage Labo' },
      byline: {
        value: 'First version of Trapped Vintage thrift shop online',
      },
      cta: { value: 'Shop ça →' },
      handle: 'freestyle',
      spread: {
        reference: {
          ...
          alt: 'Des kilos de vêtements prêt à partir vers nos clients !',
          previewImage: {
            url: 'https://cdn.shopify.com/s/files/1/0655/8344/8322/files/d83888_0c8b44a568f546aeafef47eed0234bdb_mv2_1.png?v=1659608357',
          },
    ...
    // secondaryHero
    {
      ...
      spread: {
        reference: {
          ...
          previewImage: {
            url: 'https://cdn.shopify.com/s/files/1/0655/8344/8322/files/tenor.gif?v=1659616463',
          },
